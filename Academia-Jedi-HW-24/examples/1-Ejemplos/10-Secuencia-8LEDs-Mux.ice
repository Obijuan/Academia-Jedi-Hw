{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "d990b031-cf6b-49e4-9e71-61e82cba6162",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        {
          "id": "a3207838-d1d5-427e-b254-09f1679c3f57",
          "type": "basic.input",
          "data": {
            "name": "Interruptor",
            "pins": [
        ...
        {
          "id": "a276f694-cdfa-4263-b517-403e52a0e680",
          "type": "basic.memory",
          "data": {
            "name": "",
            "list": "F0 // 11110000\n0F // 00001111",
        ...
        {
          "id": "5d8d4db0-e237-41ef-8818-bef60b250c62",
        ...
        {
          "id": "06923401-0038-4831-a5d3-b3c88b42a8c9",
        ...
        {
          "id": "77d4de8a-07cd-4ed6-8e0e-80482d8db64c",
        ...
        {
          "id": "27e5fc59-da7c-4744-aee1-acb86d2f378a",
          "type": "86165623aeffaf68335bc416b0b083b74812e866",
          "position": {
            "x": 56,
            "y": 248
        ...
        {
          "id": "7e04ba8f-aaf3-488d-9f71-7751c96f2e2e",
      ...
      "wires": [
        {
          "source": {
            "block": "77d4de8a-07cd-4ed6-8e0e-80482d8db64c",
            "port": "7340e107-20a2-41fb-b78e-132f842054f4"
          },
          "target": {
            "block": "5d8d4db0-e237-41ef-8818-bef60b250c62",
        ...
        },
        {
          ...
          "target": {
            "block": "06923401-0038-4831-a5d3-b3c88b42a8c9",
        ...
        {
          "source": {
            "block": "a276f694-cdfa-4263-b517-403e52a0e680",
            "port": "memory-out"
          },
          "target": {
            "block": "27e5fc59-da7c-4744-aee1-acb86d2f378a",
            "port": "c71c44ac-0500-4eb5-9c1c-4ea21cd78377"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "7e04ba8f-aaf3-488d-9f71-7751c96f2e2e",
        ...
        {
          "source": {
            "block": "a3207838-d1d5-427e-b254-09f1679c3f57",
            "port": "out"
          },
          "target": {
            "block": "06923401-0038-4831-a5d3-b3c88b42a8c9",
        ...
        },
        {
          ...
          "target": {
            "block": "d990b031-cf6b-49e4-9e71-61e82cba6162",
            "port": "in"
          },
          "size": 8
        }
