{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "375c7efd-d190-47a1-bf12-2812a15820f9",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "62202b9d-93ec-4d75-9b94-bf0f40337ff5",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "012ea742-4072-4688-82e1-ec1cc3183bf5",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "9b8e8559-aa64-48b2-8dd0-7f444c482c07",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "eaa71909-8e2f-4449-8463-1b95b03d77aa",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "f7eae2bd-a975-4cdb-95fd-116031c6d917",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "dec58658-df99-4fa7-a80a-fb2124db18e6",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "9db00eb2-3322-4604-82f9-c78512f23535",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "493fa273-d9d5-4c93-8c19-3fa1e938e4de",
        ...
        {
          "id": "0c3b328b-0c5f-4b1b-a728-16b2d5b7ee66",
        ...
        {
          "id": "051934d2-227e-41ad-89eb-2d596e34594d",
          "type": "basic.info",
          "data": {
            "info": "<B>Ejercicio 7.1</B>: (Solución) Hacer un circuito digital que haga parpadear\nalternativamente los LEDs pares y los impares a una velocidad de una vez por segundo\n\n  ",
            "readonly": true
          },
          "position": {
            "x": -32,
      ...
      "wires": [
        {
          "source": {
            "block": "493fa273-d9d5-4c93-8c19-3fa1e938e4de",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "375c7efd-d190-47a1-bf12-2812a15820f9",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "012ea742-4072-4688-82e1-ec1cc3183bf5",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "eaa71909-8e2f-4449-8463-1b95b03d77aa",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "dec58658-df99-4fa7-a80a-fb2124db18e6",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "0c3b328b-0c5f-4b1b-a728-16b2d5b7ee66",
        ...
        },
        {
          ...
          "target": {
            "block": "62202b9d-93ec-4d75-9b94-bf0f40337ff5",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "9b8e8559-aa64-48b2-8dd0-7f444c482c07",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "f7eae2bd-a975-4cdb-95fd-116031c6d917",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "9db00eb2-3322-4604-82f9-c78512f23535",
            "port": "in"
          }
        }
      ]
