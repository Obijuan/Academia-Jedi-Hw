{
  "version": "1.2",
  "package": {
    "name": "Contador-4bits-up-rst-system",
    "version": "0.1",
    "description": "Contador del sistema, módulo M, ascendente, de 4 bits, con reset ",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "6df03900-dd92-4ac9-a53c-48fe64214fed",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[3:0]",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "6df03900-dd92-4ac9-a53c-48fe64214fed",
            "port": "in"
          },
          "size": 4
        }
