      ...
      "blocks": [
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<B>Ejercicio 5.2</B>: (1 Bitpoint) Instalar la colección utilizada en el curso de FPGAs que\nse dió en el centro Don Bosco, en Errentería: \n\nhttps://github.com/Obijuan/Curso-Electronica-Digital-para-makers-con-FPGAs-Libres/wiki\n  ",
            "readonly": true
          },
          "position": {
            "x": 24,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Seleccionar 4 ó 5 componetes al azar, y colocarlos (no hace falta \ncrear un circuito ni tirar cables)",
            "readonly": true
          },
          "position": {
            "x": 32,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Entregar:\n\n  -1 pantallazo\n  \n  Enviarlo por redes sociales (Twitter, G+) con mención \n  a @Obijuan_cube",
            "readonly": false
          },
          "position": {
            "x": 32,
