{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "8f7bbf98-dcdc-4b15-839f-551663d40a26",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        {
          "id": "2a2ea5a3-bcde-4c19-b062-23963a2fb5e1",
          "type": "basic.output",
          "data": {
            "name": "Canal 2",
            "pins": [
        ...
        {
          "id": "f2c7ccc4-fe0d-45da-ae04-7cdc23c99e84",
          "type": "basic.output",
          "data": {
            "name": "Canal 2",
            "pins": [
        ...
        {
          "id": "127a7e99-1926-4b83-9490-7a2ce51d40af",
          "type": "basic.output",
          "data": {
            "name": "Canal 2",
            "pins": [
        ...
        {
          "id": "6e60e8a5-76f1-4346-9a4e-ad80cd0b1fb6",
          "type": "basic.info",
          "data": {
            "info": "Mostrar el dato recibido  \nen los LEDs, en binario",
            "readonly": true
          },
          "position": {
            "x": 280,
        ...
        {
          "id": "bb5baad7-c726-4549-9268-5021b928a5d6",
        ...
        {
          "id": "6b48561d-5965-4002-b621-b9f3b48a3645",
        ...
        {
          "id": "1b27a698-245a-461a-bf04-208f01dc06c7",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "c3672aaf-4449-42e9-9716-4a14d5b590e7",
          "type": "basic.info",
          "data": {
            "info": "**Analizador**",
            "readonly": true
        ...
        {
          "id": "b5514731-1d9a-4aa0-baa5-3f616207a5ee",
          "type": "basic.info",
          "data": {
            "info": "**Analizador**",
            "readonly": true
        ...
        {
          "id": "8afb2fb0-3b1a-42ed-980e-fde671009e6e",
          "type": "basic.info",
          "data": {
            "info": "**Analizador**",
            "readonly": true
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "8f7bbf98-dcdc-4b15-839f-551663d40a26",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "bb5baad7-c726-4549-9268-5021b928a5d6",
        ...
        },
        {
          ...
          "target": {
            "block": "6b48561d-5965-4002-b621-b9f3b48a3645",
        ...
        },
        {
          ...
          "target": {
            "block": "2a2ea5a3-bcde-4c19-b062-23963a2fb5e1",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "f2c7ccc4-fe0d-45da-ae04-7cdc23c99e84",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "127a7e99-1926-4b83-9490-7a2ce51d40af",
            "port": "in"
          }
        }
      ]
