  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "300bc54a-14e3-490a-9630-9d3be88a9aaf",
          "type": "basic.output",
          "data": {
            "name": "Zumbador",
            "pins": [
        ...
        {
          "id": "5cea4b93-112e-44d0-bf30-4fae3bcc7203",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "d0e476bf-f549-4a63-b48d-bdf058f5d649",
          "type": "basic.input",
          "data": {
            "name": "switches",
            "range": "[2:0]",
        ...
        {
          "id": "40262657-2656-483e-9f2a-6cda2f1ea3c1",
          "type": "basic.input",
          "data": {
            "name": "Pulsador",
            "pins": [
        ...
        {
          "id": "cd4993b8-bf53-4362-abd9-54ac4fb04e42",
          "type": "basic.memory",
          "data": {
            "name": "",
            "list": "0\n0\n0\n0\n0\n1\n0\n0",
        ...
        {
          "id": "d5a35ce2-ce53-4685-a2d8-deef2d488ba6",
        ...
        {
          "id": "4b72328e-35d4-49f4-b6b9-ec9624214434",
        ...
        {
          "id": "f0c1dd2a-8192-4941-a8f3-7e61a06f6164",
        ...
        {
          "id": "668639a8-9aac-4354-ab10-eababe752a4c",
        ...
        {
          "id": "eb5dcaa5-9927-4bb3-8639-34259d297535",
        ...
        {
          "id": "9a6f760d-6259-424a-8c40-ecc506718699",
          "type": "basic.info",
          "data": {
            "info": "**Sensores IR**",
            "readonly": true
        ...
        {
          "id": "0cf305c5-d61b-4d80-a710-46fbfe59d631",
          "type": "basic.info",
          "data": {
            "info": "**Disparo alarma**",
            "readonly": true
        ...
        {
          "id": "ee217f0e-acf2-463b-9b6f-2cc6b9806dc6",
          "type": "basic.info",
          "data": {
            "info": "0: Alarma en espera  \n1: Alarma disparada",
            "readonly": true
          },
          "position": {
            "x": -96,
        ...
        {
          "id": "2ccc2b88-1f75-4401-ab51-c591d50b256f",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "74c599a7-03e2-4277-8362-ccc774c35069",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "b96c95e5-d396-4eab-86a6-786a05535603",
          "type": "basic.info",
          "data": {
            "info": "Evento:  \ncódigo correcto",
            "readonly": true
        ...
        {
          "id": "644ed4f4-e9e2-459f-ae91-3b7e137040cc",
          "type": "basic.info",
          "data": {
            "info": "Introducción del  \ncódigo",
            "readonly": true
          },
          "position": {
            "x": -664,
        ...
        {
          "id": "c93a548d-41b0-42d0-ad20-b56432f1309f",
          "type": "basic.info",
          "data": {
            "info": "**Desactivación**",
            "readonly": true
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "d5a35ce2-ce53-4685-a2d8-deef2d488ba6",
        ...
        {
          "source": {
            "block": "d0e476bf-f549-4a63-b48d-bdf058f5d649",
            "port": "out"
          },
          "target": {
            "block": "4b72328e-35d4-49f4-b6b9-ec9624214434",
        ...
        {
          "source": {
            "block": "cd4993b8-bf53-4362-abd9-54ac4fb04e42",
            "port": "memory-out"
          },
          "target": {
            "block": "4b72328e-35d4-49f4-b6b9-ec9624214434",
        ...
        },
        {
          ...
          "target": {
            "block": "f0c1dd2a-8192-4941-a8f3-7e61a06f6164",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
          "source": {
            "block": "40262657-2656-483e-9f2a-6cda2f1ea3c1",
            "port": "out"
          },
          "target": {
            "block": "f0c1dd2a-8192-4941-a8f3-7e61a06f6164",
        ...
        },
        {
          ...
          "target": {
            "block": "668639a8-9aac-4354-ab10-eababe752a4c",
        ...
        },
        {
          ...
          "target": {
            "block": "300bc54a-14e3-490a-9630-9d3be88a9aaf",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "eb5dcaa5-9927-4bb3-8639-34259d297535",
        ...
        },
        {
          ...
          "target": {
            "block": "5cea4b93-112e-44d0-bf30-4fae3bcc7203",
            "port": "in"
          }
        },
        {
