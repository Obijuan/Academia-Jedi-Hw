{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "691b3626-065e-44e0-bbd0-bbdf8e73c1a5",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "a0073cbe-1429-4fa7-949a-dd527f870dac",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "d9e73a1d-7c5b-4b66-8de1-229d54e4903e",
        ...
        {
          "id": "cb51720f-c4a0-46ea-b1ec-5c3b845f9df8",
          "type": "basic.info",
          "data": {
            "info": "<B>Ejercicio 6.1</B> (Solución)\n\nHacer un circuito digital que haga parpadear los\nLEDs 0 y 7 a la vez, a la velocidad de un parpadeo por segundo\n",
            "readonly": true
          },
          "position": {
            "x": 128,
      ...
      "wires": [
        {
          "source": {
            "block": "d9e73a1d-7c5b-4b66-8de1-229d54e4903e",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "691b3626-065e-44e0-bbd0-bbdf8e73c1a5",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "a0073cbe-1429-4fa7-949a-dd527f870dac",
            "port": "in"
          }
        }
      ]
